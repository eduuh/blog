...
draft: false
linktitle: ""
title: "Managing Dotfiles with bare repository"
...
Hello am edd was having trouble with configuration since i started using `docker` for my `development`.I realized i was reconfiguring eachtime i recreated a new environment. For consistecy and time saving , i decided it would be great if could sync my dotfiles using `git and github` and when creating `new enviroments`.
